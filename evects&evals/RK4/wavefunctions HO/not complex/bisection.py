...
if __name__ == "__main__":
    ...
    # find_multiple_odd_eigenvalues(Es, tolerance, Ψ_init, Φ_init, dx)
    # print(f"\n{tolerance = }")

    #################################################

    print("\n~* even wavefunction TEST*~")
    E_min = 0
    E_max = 2
    nE = 512
    dE = (E_max - E_min) / nE
    ...
    find_multiple_even_eigenvalues(Es, tolerance, Ψ_init, Φ_init, dx)
    print(f"\n{tolerance = }")
